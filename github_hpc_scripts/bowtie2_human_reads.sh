...
do
bowtie2 -x /dfs5/bio/rothmanj/databases/grch38_1kgmaj -1 ${f}_READ1.dedupe.fastq.gz -2 ${f}_READ2.dedupe.fastq.gz -p 15 -S ${f}_human_reads.sam --un-conc-gz ${f}.nohuman.fastq.gz
done